...
# Timestamp: 2018-06-14 09:33:53 UTC
# 
...
RUN bash -c 'source activate neuro && cd /data && datalad install -r ///workshops/nih-2017/ds000114 && cd ds000114 && datalad update -r && datalad get -r sub-01/ses-test/anat  sub-02/ses-test/anat'
...
RUN echo '{ \
    ...
    \n    [ \
    \n      "run_bash", \
    \n      "source activate neuro && cd /data && datalad install -r ///workshops/nih-2017/ds000114 && cd ds000114 && datalad update -r && datalad get -r sub-01/ses-test/anat  sub-02/ses-test/anat" \
    \n    ], \
    \n    [ \
    \n      "copy", \
    \n      [ \
